...
import {
  ...
  InvestmentsCreate,
  InvestmentsEdit,
} from './resources/Investments';
import {
  DailyEarningsList,
  DailyEarningsCreate,
  DailyEarningsEdit,
} from './resources/DailyEarnings';
import UsersIcon from '@mui/icons-material/AccountBox';
import MachinesIcon from '@mui/icons-material/Settings';
import InvestmentsIcon from '@mui/icons-material/MonetizationOn';
import DailyEarningsIcon from '@mui/icons-material/AttachMoney';
// SUPERTOKENS
...
const App = () => (
  <SuperTokensWrapper>
    <BrowserRouter basename="/a3ac0f9e4">
      <Admin
        authProvider={
      ...
      >
        ...
        <Resource
          name="Investments"
          options={{ label: 'Investments' }}
          list={InvestmentsList}
          create={InvestmentsCreate}
          edit={InvestmentsEdit}
          recordRepresentation="investmentDate"
          icon={InvestmentsIcon}
        />
        <Resource
          name="DailyEarnings"
          options={{ label: 'Daily Earnings' }}
          list={DailyEarningsList}
          create={DailyEarningsCreate}
          edit={DailyEarningsEdit}
          recordRepresentation="earningsDate"
          icon={DailyEarningsIcon}
        />
